...
WebUI.setText(findTestObject('CheckoutComponents/input_ng nhp_email'), 'ngocphupham682001@gmail.com')

WebUI.setText(findTestObject('CheckoutComponents/input_ng nhp_phoneNumber'), '0786698')
...
WebUI.verifyElementPresent(findTestObject('Utils/thongBao'), 0)
