...
WebUI.setText(findTestObject('CheckoutComponents/input_ng nhp_nameCustomer'), 'Pham Ngoc Phu')
...
WebUI.verifyTextPresent('Chuyển đến trang phương thức thanh toán', false)
