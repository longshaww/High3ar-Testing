...
WebUI.setText(findTestObject('VoucherManagementComponents/discountInput'), '0')
...
WebUI.setText(findTestObject('VoucherManagementComponents/input_S lng_qty'), '2')

WebUI.click(findTestObject('VoucherManagementComponents/button_Create'))

WebUI.verifyElementText(findTestObject('Utils/thongBao'), 'Số lượng không hợp lệ')
