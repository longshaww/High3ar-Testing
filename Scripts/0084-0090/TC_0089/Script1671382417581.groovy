...
WebUI.click(findTestObject('VoucherManagementComponents/buttonXacThucDelete'))

WebUI.verifyElementText(findTestObject('Utils/thongBao'), 'Xóa voucher thành công')
