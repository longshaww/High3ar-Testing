...
WebUI.setText(findTestObject('Object Repository/RegisterComponents/input_N_email'), 'at400123')

WebUI.setEncryptedText(findTestObject('Object Repository/RegisterComponents/input_N_password'), 'gHBVl9PSIw9LbqXVLIdJ+Q==')

WebUI.click(findTestObject('Object Repository/RegisterComponents/buttonDki'))

WebUI.verifyElementText(findTestObject('Utils/thongBao'), 'Nhập Sai Email')
