...
WebUI.setText(findTestObject('Object Repository/RegisterComponents/input_N_password'), '')

WebUI.verifyElementNotClickable(findTestObject('RegisterComponents/buttonDki'))
