...
WebUI.setText(findTestObject('UserManagementComponents/matKhauInput'), '')

WebUI.verifyElementNotClickable(findTestObject('UserManagementComponents/buttonDoiMatKhau'))
