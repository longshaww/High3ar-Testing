...
WebUI.setText(findTestObject('UserManagementComponents/soTienDaMuaInput'), '1000')

WebUI.click(findTestObject('UserManagementComponents/buttonSuaThongTin'))

WebUI.verifyElementText(findTestObject('Utils/thongBao'), 'Số tiền nhập sai quy định rank')
