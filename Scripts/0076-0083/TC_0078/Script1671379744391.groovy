...
WebUI.setText(findTestObject('UserManagementComponents/tenNguoiDungInput'), '')

WebUI.click(findTestObject('UserManagementComponents/buttonSuaThongTin'))

WebUI.verifyElementText(findTestObject('Utils/thongBao'), 'Tên người dùng không để trống')
