...
WebUI.click(findTestObject('UserManagementComponents/buttonMoBlockNguoiDung'))

WebUI.verifyElementText(findTestObject('Utils/thongBao'), 'MỞ BLOCK USER THÀNH CÔNG')
