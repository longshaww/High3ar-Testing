...
WebUI.setText(findTestObject('OnlinePaymentComponents/ngayHetHanInput'), '03/33')

WebUI.selectOptionByLabel(findTestObject('OnlinePaymentComponents/quocGiaSelect'), '', false)
