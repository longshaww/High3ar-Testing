...
WebUI.setText(findTestObject('ChangePasswordComponents/matKhauCuInput'), '123')

WebUI.setText(findTestObject('ChangePasswordComponents/matKhauMoiInput'), 'Shadoww123')

WebUI.setText(findTestObject('ChangePasswordComponents/xacNhanLaiMatKhauInput'), 'Shadoww123')

WebUI.click(findTestObject('ChangePasswordComponents/buttonDoiMatKhau'), FailureHandling.STOP_ON_FAILURE)
