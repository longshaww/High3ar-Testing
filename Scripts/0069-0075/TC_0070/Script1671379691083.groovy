...
WebUI.setText(findTestObject('ChangePasswordComponents/matKhauMoiInput'), '1234')

WebUI.setText(findTestObject('ChangePasswordComponents/xacNhanLaiMatKhauInput'), '1234')

WebUI.verifyElementText(findTestObject('Utils/thongBao'), 'Password phải có kí tự đăc biệt,số,chữ hoa,độ dài > 6 ')
